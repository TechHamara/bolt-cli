...
class CreateCommand extends Command<int> {
  ...
  Future<int> run() async {
    ...
    if (argResults!.rest.length == 1) {
      inputName = argResults!.rest.first;
    } else {
      printUsage();
      return 64; // Exit code 64 indicates usage error
    }

    // Auto-convert name to UpperCamelCase (PascalCase) for proper Kotlin/Java naming guidelines
    final name = inputName.pascalCase;
...
''').interact();
    ...
    final filesToCreate = <String, String>{
      ...
      ...{
        ...
        p.join(projectDir, '.vscode', 'settings.json'): getVscodeSettingsJson(providedDepJars),
      },
    };
