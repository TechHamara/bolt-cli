String getExtensionTempJava(String name, String org, [String? author]) {
  final description = author != null && author.isNotEmpty
      ? 'Developed by $author using Bolt.'
      : 'Extension component for $name. Built with <3 and Bolt.';
  return '''
package $org;
...
String getExtensionTempKt(String name, String org, [String? author]) {
  final description = author != null && author.isNotEmpty
      ? 'Developed by $author using Bolt.'
      : 'Extension component for $name. Built with <3 and Bolt.';
  return '''
