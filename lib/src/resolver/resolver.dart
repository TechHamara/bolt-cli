...
class ArtifactResolver {
  var _mvnRepos = <String>{
    // The default repositories that Bolt will consult when resolving
    ...
    'https://jitpack.io', // Sonatype OSSRH repositories for Bolt processor and annotations artifacts
