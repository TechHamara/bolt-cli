...
public @interface Extension {
    ...
    /**
     * The version of the extension component.
     *
     * @return the version of the extension component
     */
    String version() default "1";

    /**
     * The version name of the extension component.
     *
     * @return the version name of the extension component
     */
    String versionName() default "1.0";
}
