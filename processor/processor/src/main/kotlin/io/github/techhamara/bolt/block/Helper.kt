package io.github.techhamara.bolt.block
...
private object HelperSingleton {
    ...
    init {
        val classesDir = Paths.get(System.getenv("BOLT_PROJECT_ROOT"), ".bolt", "build", "classes")
        val annotationsJar = Paths.get(System.getenv("BOLT_ANNOTATIONS_JAR"))
        val runtimeJar = Paths.get(System.getenv("BOLT_RUNTIME_JAR"))
